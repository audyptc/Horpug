...
func main() {
	...
	setupScalarDocs(app)
	deliveryhttp.SetupRoutes(app, container.AuthUC, container.UserUC, container.RoleUC, container.PermUC, container.MenuUC, container.RoomUC, container.TenantUC, container.ContractUC, container.MeterReadingUC, container.BillUC, container.DashboardUC, container.AnalyticsUC, container.ExpenseUC, container.MaintenanceUC, container.PaymentUC)
